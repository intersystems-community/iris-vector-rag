...
class TestEnsureHNSWIndex:
    ...
    def test_ensure_hnsw_index_acorn_success(self, schema_manager):
        ...
        assert "CREATE INDEX idx_Entities_embedding ON RAG.Entities(embedding) AS HNSW WITH (ACORN=1)" == create_call
    ...
    def test_ensure_hnsw_index_entities_table(self, schema_manager):
        ...
        assert create_sql == "CREATE INDEX idx_Entities_embedding ON RAG.Entities(embedding) AS HNSW"
...
class TestEnsureAllVectorIndexes:
    ...
    def test_ensure_all_vector_indexes_success(self, schema_manager):
        ...
        source_docs_create = [call for call in create_calls if "SourceDocuments" in call]
