...
class TestPyLateColBERTErrorHandling:
    ...
    def test_error_includes_pipeline_context(
        ...
        assert (
            ...
            or "pylate" in error_msg
            or "rag" in error_msg
            or "pipeline" in error_msg
    ...
    def test_colbert_model_loading_error(
        self, pylate_colbert_pipeline, mocker, sample_query
    ):
        """
    ...
    def test_colbert_score_computation_error(
        ...
        if hasattr(pylate_colbert_pipeline, "colbert_encoder"):
            ...
            mocker.patch.object(
                ...
                side_effect=RuntimeError(
                    "Score computation failed: tensor dimension mismatch"
                ),
            )
    ...
    def test_late_interaction_timeout_handled(
        self, pylate_colbert_pipeline, mocker, caplog, sample_query
    ):
        """
    ...
    def test_token_embedding_dimension_error(
        self, pylate_colbert_pipeline, mocker, sample_query
    ):
        """
        ...
        if hasattr(pylate_colbert_pipeline, "colbert_encoder"):
            ...
            try:
                ...
                if "dimension" in error_msg or "token" in error_msg:
                    ...
                    assert (
                        "expected" in error_msg or "token" in error_msg
