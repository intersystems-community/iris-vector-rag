...
class TestOntologyLoader:
    ...
    def test_rdf_format_support(self):
        ...
        mock_rdf_data = {
            "triples": [
                {"subject": "rdf_001", "predicate": "rdfs:label", "object": "RDF Concept"},
                {"subject": "rdf_002", "predicate": "rdfs:subClassOf", "object": "rdf_001"}
            ]
        }
    ...
    def test_skos_format_support(self):
        ...
        mock_skos_data = {
            "concepts": [
                {"id": "skos_001", "prefLabel": "SKOS Concept", "altLabel": ["Alternative Label"]},
                {"id": "skos_002", "prefLabel": "Related Concept", "related": ["skos_001"]}
            ]
        }
            ...
            "sources": [
                {
                    ...
                    "concepts": [
                        ...
                        {"id": "transaction", "label": "Transaction", "synonyms": ["txn"]}
                    ]
                }
            ]
        }
...
class TestEntityExtraction:
                ...
                "sources": [
                    {
                        ...
                        "domain": "general",
                        "concepts": [
                            {"id": "contract", "label": "Contract", "synonyms": ["agreement"]},
                            {"id": "medication", "label": "Medication", "synonyms": ["drug", "medicine"]},
    ...
    def test_entity_extraction_with_general_ontology(self):
        ...
        for doc in test_documents:
            entities = self.extractor.extract_with_ontology(
                doc.page_content, 
                doc
            )
...
class TestPerformance:
    ...
    def test_general_plugin_loading_performance(self):
        ...
        sample_source = {
            ...
            "domain": "general",
            "concepts": [
                {"id": f"concept_{i}", "label": f"Concept {i}", "synonyms": [f"synonym_{i}"]}
    ...
    def test_auto_detection_performance(self):
        ...
        large_source = {
            ...
            "domain": "mixed",
            "concepts": [
                {"id": f"medical_{i}", "label": f"Medical Concept {i}", "domain": "medical"}
                for i in range(50)
            ] + [
    ...
    def test_reasoning_performance_general(self):
        ...
        for i in range(50):
            ...
            if i > 0:
                plugin.hierarchy.add_relationship(f"concept_{i}", f"concept_{i-1}", "is_a")
...
class TestIntegration:
    ...
    def test_end_to_end_general_workflow(self):
        ...
        config_manager._config = {
            "entity_extraction": {"method": "ontology_hybrid", "confidence_threshold": 0.6},
            "ontology": {"enabled": True, "type": "general", "auto_detect_domain": True}
        }
