...
from iris_rag.core.models import Document, Entity, Relationship, EntityTypes, RelationshipTypes
...
class TestEntityExtractionService:
    ...
    def test_storage_adapter_integration(self):
        ...
        result = service.store_entities_and_relationships(test_entities, test_relationships)
        
        assert result is True
        service.storage_adapter.store_entities_batch.assert_called_once_with(test_entities)
        service.storage_adapter.store_relationships_batch.assert_called_once_with(test_relationships)
