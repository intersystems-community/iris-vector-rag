...
def get_expected_rag_schema() -> List[SchemaDefinition]:
    ...
    return [
        SchemaDefinition(
            ...
            schema_name="RAG",
            columns=[
                ColumnDefinition("doc_id", ColumnType.VARCHAR, nullable=False, max_length=255),
                ColumnDefinition("title", ColumnType.VARCHAR, nullable=True, max_length=1000),
                ColumnDefinition("abstract", ColumnType.CLOB, nullable=True),
                ColumnDefinition("text_content", ColumnType.CLOB, nullable=True),
                ColumnDefinition("authors", ColumnType.CLOB, nullable=True),
                ColumnDefinition("keywords", ColumnType.CLOB, nullable=True),
                ColumnDefinition("metadata", ColumnType.JSON, nullable=True),
                ColumnDefinition("embedding", ColumnType.VECTOR, nullable=True),
                ColumnDefinition("created_timestamp", ColumnType.DATETIME, nullable=True),
            ],
            primary_key="doc_id"
        ),
        SchemaDefinition(
            ...
            columns=[
                ...
                ColumnDefinition("chunk_id", ColumnType.VARCHAR, nullable=True, max_length=255),
                ColumnDefinition("source_document_id", ColumnType.VARCHAR, nullable=True, max_length=255),
                ColumnDefinition("chunk_text", ColumnType.CLOB, nullable=True),
                ColumnDefinition("chunk_embedding", ColumnType.VECTOR, nullable=True),
                ColumnDefinition("chunk_index", ColumnType.INT, nullable=True),
                ColumnDefinition("chunk_type", ColumnType.VARCHAR, nullable=True, max_length=100),
                ColumnDefinition("metadata", ColumnType.CLOB, nullable=True),
        ...
        SchemaDefinition(
            ...
            schema_name="RAG",
            columns=[
                ColumnDefinition("entity_id", ColumnType.VARCHAR, nullable=False, max_length=255),
                ColumnDefinition("entity_name", ColumnType.VARCHAR, nullable=False, max_length=500),
                ColumnDefinition("entity_type", ColumnType.VARCHAR, nullable=True, max_length=100),
                ColumnDefinition("description", ColumnType.VARCHAR, nullable=True, max_length=2000),
                ColumnDefinition("confidence", ColumnType.VARCHAR, nullable=True, max_length=50),
                ColumnDefinition("source_doc_id", ColumnType.VARCHAR, nullable=True, max_length=255),
                ColumnDefinition("created_timestamp", ColumnType.DATETIME, nullable=True),
            ],
        ...
        SchemaDefinition(
            ...
            schema_name="RAG",
            columns=[
                ColumnDefinition("relationship_id", ColumnType.VARCHAR, nullable=False, max_length=255),
                ...
                ColumnDefinition("relationship_type", ColumnType.VARCHAR, nullable=True, max_length=255),
                ColumnDefinition("weight", ColumnType.VARCHAR, nullable=True, max_length=50),
                ColumnDefinition("confidence", ColumnType.VARCHAR, nullable=True, max_length=50),
                ColumnDefinition("source_document", ColumnType.VARCHAR, nullable=True, max_length=255),
                ColumnDefinition("created_timestamp", ColumnType.DATETIME, nullable=True),
            ],
