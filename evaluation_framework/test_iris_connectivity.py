...
class IRISConnectivityTest:
    ...
    def test_iris_connection(self) -> bool:
        ...
        try:
            ...
            if self.connection is None:
                logger.warning("⚠ IRIS connection returned None - database may not be running")
                return False
    ...
    def test_pipeline_targets(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Pipeline import success rate: {pipelines_success}/{pipelines_tested} ({success_rate:.1%})")
    ...
    def run_all_tests(self) -> Dict[str, bool]:
        ...
        if passed >= total * 0.6:  # 60% pass rate for basic connectivity
            logger.info("🎉 IRIS connectivity tests PASSED - framework ready for evaluation")
            return True
        else:
