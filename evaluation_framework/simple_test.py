...
def test_core_imports() -> Dict[str, bool]:
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location(
            ...
            "biomedical_question_generator.py"
        )
...
def test_data_structures() -> Dict[str, bool]:
    ...
    try:
        ...
        # Test ranking
        df['overall_score'] = df[['faithfulness', 'answer_relevancy', 'context_precision', 'context_recall']].mean(axis=1)
        ...
        logger.info(f"  Best pipeline: {df_ranked.iloc[0]['pipeline_name']} (score: {df_ranked.iloc[0]['overall_score']:.3f})")
...
<body>
    ...
    <div class="metric">
        ...
        report_data = {
            ...
            "pipelines_evaluated": ["BasicRAG", "CRAG", "GraphRAG", "BasicRAGReranking"],
            "metrics": {
...
def run_simplified_validation() -> bool:
    ...
    if import_success:
        ...
        logger.warning("⚠ Some core imports failed (expected for missing ML dependencies)")
