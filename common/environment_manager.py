...
class EnvironmentManager:
    ...
    def get_best_python_executable(self) -> str:
        ...
        if self.force_env:
            if self.force_env == "system":
                ...
                logger.warning(f"FORCE_ENV={self.force_env} not valid, using auto-detection")
    ...
    def _check_environment_has_iris(self, python_exe: Optional[str] = None) -> bool:
        ...
        try:
            ...
            result = subprocess.run([
                python_exe, "-c", 
                "try: import intersystems_iris.dbapi as iris; print(hasattr(iris, 'connect')); except ImportError: import iris; print(hasattr(iris, 'connect'))"
    ...
    def run_in_best_environment(self, script_path: str, args: list = None) -> subprocess.CompletedProcess:
        """
