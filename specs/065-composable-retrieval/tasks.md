...
- [ ] T043 [P] Update `README.md` with composable query examples drawn from `specs/065-composable-retrieval/quickstart.md`
...
- [ ] T046 Run the full existing test suite; confirm zero regressions (Principle IV, SC-007)
