...
def test_connection_manager_imports():
    ...
    assert hasattr(ConnectionManager, 'create_connection'), \
        "ConnectionManager should have create_connection method"
...
def test_old_top_level_common_removed():
    ...
    BEFORE FIX: from common.X import Y might work (if loaded first) or conflict
