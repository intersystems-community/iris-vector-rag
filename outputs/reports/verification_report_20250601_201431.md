...
- **Start Time**: 2025-06-01T20:14:22.355274
- **End Time**: 2025-06-01T20:14:31.921332
...
- **Hnsw Indexing**: ❌ FAILED
  - Error: java.sql.SQLException: [SQLCODE: <-29>:<Field not found in the applicable tables>]
[Location: <Prepare>]
[%msg: < Field 'INDEX_TYPE' not found in the applicable tables^SELECT TABLE_NAME , INDEX_NAME FROM INFORMATION_SCHEMA . INDEXES WHERE INDEX_TYPE =>]
...
- HNSW indexing test failed: java.sql.SQLException: [SQLCODE: <-29>:<Field not found in the applicable tables>]
[Location: <Prepare>]
[%msg: < Field 'INDEX_TYPE' not found in the applicable tables^SELECT TABLE_NAME , INDEX_NAME FROM INFORMATION_SCHEMA . INDEXES WHERE INDEX_TYPE =>]
