...
class GraphRAGPerformanceMonitor:
    ...
    def record_query_performance(
        ...
        with self._performance_lock:
            ...
            self._check_performance_thresholds(response_time_ms, database_time_ms, hnsw_time_ms)
    ...
    def get_current_performance(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'meets_sla': snapshot.query_response_time_ms < self.thresholds['max_response_time_ms']
        }
    ...
    def get_performance_summary(self, time_range_minutes: int = 60) -> Dict[str, Any]:
        ...
        summary = {
            ...
            'response_time_stats': {
                ...
                'sla_compliance': sum(1 for t in response_times if t < 200) / len(response_times)
            },
            'cache_performance': {
            ...
            'optimization_effectiveness': self._calculate_optimization_effectiveness(recent_snapshots)
        }
    ...
    def get_component_health(self) -> Dict[str, Any]:
        ...
        if self.cache_manager:
            try:
                ...
                health_status['cache_manager'] = {
                    ...
                    'health_grade': 'excellent' if cache_stats['overall']['overall_hit_rate'] > 0.8 else 'good'
                }
        ...
        if self.connection_pool:
            try:
                ...
                health_status['connection_pool'] = {
                    ...
                    'health_grade': 'excellent' if utilization < 0.7 else 'good' if utilization < 0.9 else 'warning'
                }
            except Exception as e:
        ...
        if self.parallel_processor:
            try:
                ...
                health_status['parallel_processor'] = {
                    ...
                    'health_grade': 'excellent' if processor_stats['avg_execution_time'] < 0.1 else 'good'
                }
            except Exception as e:
                health_status['parallel_processor'] = {'status': 'error', 'error': str(e)}
        ...
        if self.database_optimizer:
            try:
                ...
                health_status['database_optimizer'] = {'status': 'error', 'error': str(e)}
            ...
            try:
                ...
                if tuning_summary.get('status') != 'no_tuning_performed':
                    health_status['hnsw_tuner'] = {
                        'status': 'healthy',
                        'configurations_tested': tuning_summary['total_configurations_tested'],
    ...
    def generate_html_dashboard(self) -> str:
        ...
        response_class = self._get_css_class_for_response_time(current_perf['response_time_ms'])
    ...
    def _capture_performance_snapshot(self) -> PerformanceSnapshot:
        ...
        if self.connection_pool:
            try:
                pool_stats = self.connection_pool.get_pool_stats()
                connection_utilization = pool_stats['active_connections'] / max(1, pool_stats['peak_size'])
            except:
                pass
    ...
    def _check_performance_thresholds(self, response_time_ms: float, db_time_ms: float, hnsw_time_ms: float) -> None:
    ...
    def _create_alert(self, alert_type: str, severity: str, message: str, value: float, threshold: float) -> None:
    ...
    def _calculate_optimization_effectiveness(self, snapshots: List[PerformanceSnapshot]) -> Dict[str, float]:
...
class PerformanceMetricsAggregator:
    ...
    def record_query(self, response_time_ms: float, cache_hit: bool, db_time_ms: float, hnsw_time_ms: float) -> None:
    ...
    def get_current_metrics(self) -> Dict[str, float]:
        ...
        with self._lock:
            ...
            return {
                ...
                'avg_database_time_ms': sum(self.database_times) / len(self.database_times) if self.database_times else 0.0,
                'avg_hnsw_time_ms': sum(self.hnsw_times) / len(self.hnsw_times) if self.hnsw_times else 0.0
            }