...
from .models import DesiredState, ReconciliationAction, ConvergenceCheck, DriftIssue
...
class ConvergenceVerifier:
    ...
    def check_convergence(
        self, desired_state: DesiredState, actions_taken: List[ReconciliationAction]
    ) -> ConvergenceCheck:
        """
        ...
        try:
            ...
            convergence_check = ConvergenceCheck(converged=converged, remaining_issues=remaining_issues)
