...
class DriftAnalyzer:
    ...
    def analyze_drift(self, current_state: SystemState, desired_state: DesiredState) -> DriftAnalysis:
        ...
        if desired_state.completeness_requirements.require_all_docs and current_state.documents_without_any_embeddings > 0:
            issues.append(DriftIssue(
        ...
        if desired_state.completeness_requirements.require_token_embeddings and current_state.documents_with_incomplete_embeddings_count > 0:
            issues.append(DriftIssue(
