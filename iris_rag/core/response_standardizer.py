...
class ResponseStandardizer:
    ...
    @staticmethod
    def standardize_response(raw_response: Dict[str, Any], 
                           pipeline_type: str = "unknown") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.debug(f"Standardized response for {pipeline_type}: "
    ...
    @staticmethod
    def _generate_contexts(raw_response: Dict[str, Any], 
    ...
    @staticmethod
    def _build_metadata(raw_response: Dict[str, Any], 
                       pipeline_type: str,
...
def standardize_pipeline_response(response: Dict[str, Any], 
                                pipeline_type: str = "unknown") -> Dict[str, Any]:
    """
