...
class DataSyncManager:
    ...
    def _sync_ifind_table(self) -> SyncResult:
        ...
        try:
            ...
            if source_count == ifind_count:
                return SyncResult(
                    SyncOperation.POPULATE_IFIND, True, f"IFind table already synchronized ({ifind_count} rows)"
                )
            ...
            if new_ifind_count == source_count:
                ...
                return SyncResult(
                    SyncOperation.POPULATE_IFIND, False, f"IFind sync incomplete: {new_ifind_count}/{source_count} rows"
                )
    ...
    def _sync_chunk_data(self) -> SyncResult:
        ...
        try:
            ...
            return SyncResult(
                SyncOperation.POPULATE_CHUNKS, True, f"Chunk sync skipped - would require document reprocessing"
            )
    ...
    def _sync_token_embeddings(self) -> SyncResult:
        ...
        try:
            ...
            if token_doc_count >= doc_count * 0.9:  # 90% coverage
                return SyncResult(
                    SyncOperation.POPULATE_TOKEN_EMBEDDINGS,
                    True,
