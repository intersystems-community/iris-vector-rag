...
class SystemValidator:
    ...
    def validate_data_integrity(self) -> ValidationResult:
        ...
        try:
            ...
            message = (
                "Data integrity validation passed" if success else f"Found {len(issues)} issues: {'; '.join(issues)}"
            )
    ...
    def validate_pipeline_functionality(self, test_queries: Optional[List[str]] = None) -> ValidationResult:
        ...
        if test_queries is None:
            test_queries = ["What is machine learning?", "Explain neural networks", "How does deep learning work?"]
    ...
    def validate_system_configuration(self) -> ValidationResult:
        ...
        try:
            ...
            required_packages = ["psutil", "docker", "numpy", "sentence_transformers"]
            ...
            config_files = ["config/monitoring.json", "config/database.json"]
            ...
            log_dirs = ["logs/performance", "logs/health_checks", "logs/errors"]
