...
This avoids the slow 100K record migration and proves the concept quickly.
"""
...
class FastHNSWValidator:
    ...
    def run_full_validation(self):
        ...
        logger.info("🚀 STARTING FAST HNSW VALIDATION")
        logger.info("=" * 60)
        ...
        try:
            ...
            if perf_results['avg_improvement'] > 50:
