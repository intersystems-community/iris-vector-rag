...
class RAGDeployment:
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        configs = {
            ...
            "production": {
                "connection_type": os.getenv("PROD_CONNECTION_TYPE", "jdbc"),
                ...
                "iris_username": os.getenv("PROD_IRIS_USER"),
                "iris_password": os.getenv("PROD_IRIS_PASS"),
                "log_level": "WARNING",
                "enable_monitoring": True
            }
        }
    ...
    def test_connection(self) -> bool:
        ...
        try:
            if self.config["connection_type"] == "odbc":
                ...
                # JDBC test would go here when fixed
                logger.warning("JDBC connection test skipped (not yet implemented)")
                return True
