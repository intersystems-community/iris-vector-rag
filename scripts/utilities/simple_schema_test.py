#!/usr/bin/env python3
"""
Simple schema test for Community Edition 2025.1 without complex dependencies.
"""
...
def test_schema():
    """Test the schema creation and vector operations."""
    
    print("=" * 60)
    print("TESTING COMMUNITY EDITION 2025.1 SCHEMA")
    print("=" * 60)
    
    # Connection string for Community Edition
    conn_str = (
        "DRIVER={InterSystems IRIS ODBC};"
        "SERVER=localhost;"
        "PORT=1972;"
        "DATABASE=USER;"
        "UID=_SYSTEM;"
