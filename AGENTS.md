...
- Python 3.12 (client), ObjectScript (VecIndex.cls), IRIS 2025.1 Community + `iris-vector-graph>=1.21.0` (VecIndex, User.Exec, IRISGraphEngine), `intersystems-irispython>=5.1.2` (iris.dbapi + intersystems_iris.createIRIS) (068-colbert-vecindex)
