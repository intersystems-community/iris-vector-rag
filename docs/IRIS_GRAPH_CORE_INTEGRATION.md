...
The rag-templates project has been enhanced with advanced hybrid search capabilities through integration with the `iris_vector_graph` module from the graph-ai project. This integration provides significant performance improvements and sophisticated search fusion algorithms.
...
└── graph-ai/               # iris_vector_graph source
    ├── iris_vector_graph/     # Domain-agnostic module
...
-- RDF-style graph tables (from iris_vector_graph.schema)
...
1. **iris_vector_graph not available**: Falls back to standard GraphRAG
...
The iris_vector_graph integration provides:
...
- [graph-ai Project README](../../graph-ai/README.md) - Source of iris_vector_graph
